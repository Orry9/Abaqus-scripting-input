...
# Create JobDir
JobDir = 'C:\Users\Gebruiker\Desktop\Masterproef Orry\Scripting\Jobs'.format(jobNumber)
os.mkdir(JobDir)
os.chdir(JobDir)
logger.info('Created directory {}'.format(JobDir))

inputExcelFile = 'C:\Users\Gebruiker\Desktop\Masterproef Orry\Input strong-axis'
